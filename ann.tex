...
\begin{figure}[ht]
  ...
  \caption[Gradient descent path]{Gradient descent follows the path with the steepest slope}
...
\begin{figure}[h]
  ...
  \caption[Neural network]{Overview of different components in a neural network}
  \label{fig:neuron}
\end{figure}
